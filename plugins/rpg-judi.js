...
let time = global.db.data.users[m.sender].judi + 600000
  if (new Date - global.db.data.users[m.sender].judi < 600000) throw `Kamu sudah judi, tidak bisa judi lagi\ntunggu selama ${msToTime(time - new Date())} lagi`
    ...
    try {
        ...
        global.db.data.users[m.sender].judi = new Date * 1
        setTimeout(() => {
