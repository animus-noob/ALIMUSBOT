...
let media = await conn.relayMessage(jid, msgs.message, {
...
return media
  ...
  conn.sendbuttonlink = async(jid, content, footer, buttonlink, rowlink, button1, row1, quoted) => {
	  let msgs = generateWAMessageFromContent(jid, {
  viewOnceMessage: {
    message: {
      messageContextInfo: {
      ...
      interactiveMessage: proto.Message.InteractiveMessage.create({
        ...
        nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
          buttons: [
          {
                 ...
                 "buttonParamsJson": 
 JSON.stringify({
 "display_text": buttonlink,
 "url": rowlink,
 "merchant_url": rowlink
            })
          },
            {
              "name": "quick_reply",
...
return media
  ...
  conn.send2Buttonimg = async(jid, img, content, footer, button1, row1, button2, row2, quoted) => {
	  let mediasi = await prepareWAMessageMedia({ image: { url: img, } }, { upload: conn.waUploadToServer });
	  let msgs = generateWAMessageFromContent(jid, {
  viewOnceMessage: {
    message: {
      messageContextInfo: {
...
return media
  ...
  conn.sendBlinkimg = async(jid, sakaimg, content, footer, namalink, urllink, quoted) => {
	  let imgsaka = await prepareWAMessageMedia({ image: { url: sakaimg, } }, { upload: conn.waUploadToServer });
	  let msgs = generateWAMessageFromContent(jid, {
  viewOnceMessage: {
    message: {
      messageContextInfo: {
      ...
      interactiveMessage: proto.Message.InteractiveMessage.create({
        ...
        nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
          buttons: [
          {
                 ...
                 "buttonParamsJson": 
 JSON.stringify({
 "display_text": namalink,
 "url": urllink,
 "merchant_url": urllink
            })
          }
          ]
        })
...
return media
  ...
  conn.sknlist = async(jid, sakaimg, content, footer, button, selc, quoted) => {
  let imgsaka = await prepareWAMessageMedia({ image: { url: sakaimg, } }, { upload: conn.waUploadToServer });
let msgs = generateWAMessageFromContent(jid, {
    viewOnceMessage: {
        message: {
